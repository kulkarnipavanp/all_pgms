...
public class BundleSeq {
	...
	public static void main(String[] args) throws IOException, InstantiationException, IllegalAccessException {
		...
		conf.addResource(new Path("/home/notroot/lab/software/hadoop-1.0.3/conf/core-site.xml"));
		conf.addResource(new Path("/home/notroot/lab/software/hadoop-1.0.3/conf/hdfs-site.xml"));
